...
public final class Module
{
    ...
    public static final Codec<Module> CODEC = RecordCodecBuilder.create(instance -> instance.group(
            ...
            STRING_OR_ARRAY.optionalFieldOf("before", List.of()).forGetter(Module::before),
            STRING_OR_ARRAY.optionalFieldOf("after", List.of()).forGetter(Module::after))
     ...
     *
     */
    public Module(String name, String versionString, int version, List<String> description, List<String> authors, List<String> depend, List<String> before, List<String> after)
    {
        this.name = name;
    ...
    final Map<ModulePart, Map<String, FullModulePart>> parts = new HashMap<>();
